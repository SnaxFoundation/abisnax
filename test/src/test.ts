...
const abiAbi = require('../../external/snaxjs/src/abi.abi.json');
const transactionAbi = require('../../external/snaxjs/src/transaction.abi.json');
...
const lib = new fastcall.Library('../build/libabisnax.so')
    .function('void* abisnax_create()')
    .function('void abisnax_destroy(void* context)')
    .function('char* abisnax_get_error(void* context)')
    .function('int abisnax_get_bin_size(void* context)')
    .function('char* abisnax_get_bin_data(void* context)')
    .function('char* abisnax_get_bin_hex(void* context)')
    .function('uint64 abisnax_string_to_name(void* context, char* str)')
    .function('char* abisnax_name_to_string(void* context, uint64 name)')
    .function('int abisnax_set_abi(void* context, uint64 contract, char* abi)')
    .function('int abisnax_set_abi_hex(void* context, uint64 contract, char* hex)')
    .function('char* abisnax_get_type_for_action(void* context, uint64 contract, uint64 action)')
    .function('int abisnax_json_to_bin(void* context, uint64 contract, char* name, char* json)')
    .function('char* abisnax_hex_to_json(void* context, uint64 contract, char* type, char* hex)');

const l = lib.interface;
const cstr = fastcall.makeStringBuffer;

const context = l.abisnax_create();

function check(result: any) {
    if (!result)
        throw new Error(l.abisnax_get_error(context).readCString());
}
...
function name(s: string) {
    return l.abisnax_string_to_name(context, cstr(s));
}
...
function abisnax_json_to_hex(contract: number, type: string, data: string) {
    check(l.abisnax_json_to_bin(context, contract, cstr(type), cstr(data)));
    return l.abisnax_get_bin_hex(context).readCString();
}

function abisnax_hex_to_json(contract: number, type: string, hex: string) {
    let result = l.abisnax_hex_to_json(context, contract, cstr(type), cstr(hex));
    checkPtr(result);
...
function check_type(contract: number, types: any, type: string, data: string, expected = data) {
    let hex = abisnax_json_to_hex(contract, type, data);
    let json = abisnax_hex_to_json(contract, type, hex);
    ...
    //console.log(js2Hex)
    if (js2Hex != hex)
        throw new Error('snaxjs hex mismatch');
    let js2Json = JSON.stringify(js2Type.deserialize(buf));
    //console.log(json);
    //console.log(js2Json);
    if (js2Json != json)
        throw new Error('snaxjs json mismatch');
}

function check_types() {
    let token = name('snax.token');
    ...
    check_throw('Error: Unsupported abi version', () => snaxjs_hex_abi_to_json(snaxjs_json_abi_to_hex({ version: 'snax::abi/9.0' })));
    snaxjs_hex_abi_to_json(snaxjs_json_abi_to_hex({ version: 'snax::abi/1.0' }));
    snaxjs_hex_abi_to_json(snaxjs_json_abi_to_hex({ version: 'snax::abi/1.1' }));

    check_type(0, js2Types, 'bool', 'true');
    check_type(0, js2Types, 'bool', 'false');
    check_throw('Error: Read past end of buffer', () => snaxjs_hex_to_json(js2Types, 'bool', ''));
    check_throw('Error: Expected true or false', () => snaxjs_json_to_hex(js2Types, 'bool', 'trues'));
    check_throw('Error: Expected true or false', () => snaxjs_json_to_hex(js2Types, 'bool', null));
    ...
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'int8', 128));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'int8', -129));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'uint8', -1));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'uint8', 256));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'int8', '128'));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'int8', '-129'));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'uint8', '-1'));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'uint8', '256'));
    ...
    check_throw('Error: Read past end of buffer', () => snaxjs_hex_to_json(js2Types, 'int16', '01'));
    check_type(0, js2Types, 'uint16', '0');
    check_type(0, js2Types, 'uint16', '65535');
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'int16', 32768));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'int16', -32769));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'uint16', -1));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'uint16', 655356));
    ...
    check_throw('Error: Expected number', () => snaxjs_json_to_hex(js2Types, 'int32', 'foo'));
    check_throw('Error: Expected number', () => snaxjs_json_to_hex(js2Types, 'int32', true));
    check_throw('Error: Expected number', () => snaxjs_json_to_hex(js2Types, 'int32', []));
    check_throw('Error: Expected number', () => snaxjs_json_to_hex(js2Types, 'int32', {}));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'int32', '2147483648'));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'int32', '-2147483649'));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'uint32', '-1'));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'uint32', '4294967296'));
    ...
    check_throw('Error: number is out of range', () => snaxjs_json_to_hex(js2Types, 'int64', '9223372036854775808'));
    check_throw('Error: number is out of range', () => snaxjs_json_to_hex(js2Types, 'int64', '-9223372036854775809'));
    check_throw('Error: invalid number', () => snaxjs_json_to_hex(js2Types, 'uint64', '-1'));
    check_throw('Error: number is out of range', () => snaxjs_json_to_hex(js2Types, 'uint64', '18446744073709551616'));
    ...
    check_throw('Error: number is out of range', () => snaxjs_json_to_hex(js2Types, 'int128', '170141183460469231731687303715884105728'));
    check_throw('Error: number is out of range', () => snaxjs_json_to_hex(js2Types, 'int128', '-170141183460469231731687303715884105729'));
    check_throw('Error: invalid number', () => snaxjs_json_to_hex(js2Types, 'int128', 'true'));
    check_throw('Error: invalid number', () => snaxjs_json_to_hex(js2Types, 'uint128', '-1'));
    check_throw('Error: number is out of range', () => snaxjs_json_to_hex(js2Types, 'uint128', '340282366920938463463374607431768211456'));
    check_throw('Error: invalid number', () => snaxjs_json_to_hex(js2Types, 'uint128', 'true'));
    ...
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'varint32', '2147483648'));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'varint32', '-2147483649'));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'varuint32', '-1'));
    check_throw('Error: Number is out of range', () => snaxjs_json_to_hex(js2Types, 'varuint32', '4294967296'));
    ...
    check_throw('Error: Invalid time format', () => snaxjs_json_to_hex(js2Types, 'time_point_sec', true));
    ...
    check_throw('Error: Invalid time format', () => snaxjs_json_to_hex(js2Types, 'time_point', true));
    ...
    check_throw('Error: Expected string containing name', () => snaxjs_json_to_hex(js2Types, 'name', true));
    check_type(0, js2Types, 'bytes', '""');
    check_type(0, js2Types, 'bytes', '"00"');
    check_type(0, js2Types, 'bytes', '"AABBCCDDEEFF00010203040506070809"');
    check_throw('Error: Odd number of hex digits', () => snaxjs_json_to_hex(js2Types, 'bytes', '"0"'));
    check_throw('Error: Expected hex string', () => snaxjs_json_to_hex(js2Types, 'bytes', '"yz"'));
    check_throw('Error: Expected string containing hex digits', () => snaxjs_json_to_hex(js2Types, 'bytes', true));
    check_throw('Error: Read past end of buffer', () => snaxjs_hex_to_json(js2Types, 'bytes', "01"));
    ...
    check_throw('Error: Read past end of buffer', () => snaxjs_hex_to_json(js2Types, 'string', '01'));
    ...
    check_throw('Error: Expected hex string', () => snaxjs_json_to_hex(js2Types, 'checksum256', 'yz'));
    check_throw('Error: Expected string containing hex digits', () => snaxjs_json_to_hex(js2Types, 'checksum256', true));
    check_throw('Error: Binary data has incorrect size', () => snaxjs_json_to_hex(js2Types, 'checksum256', 'a0'));
    check_type(0, js2Types, 'public_key', '"SNAX1111111111111111111111111111111114T1Anm"', '"PUB_K1_11111111111111111111111111111111149Mr2R"');
    check_type(0, js2Types, 'public_key', '"SNAX11111111111111111111111115qCHTcgbQwptSz99m"', '"PUB_K1_11111111111111111111111115qCHTcgbQwpvP72Uq"');
    check_type(0, js2Types, 'public_key', '"SNAX111111111111111114ZrjxJnU1LA5xSyrWMNuXTrYSJ57"', '"PUB_K1_111111111111111114ZrjxJnU1LA5xSyrWMNuXTrVub2r"');
    check_type(0, js2Types, 'public_key', '"SNAX1111111113diW7pnisfdBvHTXP7wvW5k5Ky1e5DVuF23dosU"', '"PUB_K1_1111111113diW7pnisfdBvHTXP7wvW5k5Ky1e5DVuF4PizpM"');
    check_type(0, js2Types, 'public_key', '"SNAX11DsZ6Lyr1aXpm9aBqqgV4iFJpNbSw5eE9LLTwNAxqjJgmjgbT"', '"PUB_K1_11DsZ6Lyr1aXpm9aBqqgV4iFJpNbSw5eE9LLTwNAxqjJgXSdB8"');
    check_type(0, js2Types, 'public_key', '"SNAX12wkBET2rRgE8pahuaczxKbmv7ciehqsne57F9gtzf1PVYNMRa2"', '"PUB_K1_12wkBET2rRgE8pahuaczxKbmv7ciehqsne57F9gtzf1PVb7Rf7o"');
    check_type(0, js2Types, 'public_key', '"SNAX1yp8ebBuKZ13orqUrZsGsP49e6K3ThVK1nLutxSyU5j9SaXz9a"', '"PUB_K1_1yp8ebBuKZ13orqUrZsGsP49e6K3ThVK1nLutxSyU5j9Tx1r96"');
    check_type(0, js2Types, 'public_key', '"SNAX9adaAMuB9v8yX1mZ5PtoB6VFSCeqRGjASd8ZTM6VUkiHL7mue4K"', '"PUB_K1_9adaAMuB9v8yX1mZ5PtoB6VFSCeqRGjASd8ZTM6VUkiHLB5XEdw"');
    check_type(0, js2Types, 'public_key', '"SNAX69X3383RzBZj41k73CSjUNXM5MYGpnDxyPnWUKPEtYQmTBWz4D"', '"PUB_K1_69X3383RzBZj41k73CSjUNXM5MYGpnDxyPnWUKPEtYQmVzqTY7"');
    check_type(0, js2Types, 'public_key', '"SNAX7yBtksm8Kkg85r4in4uCbfN77uRwe82apM8jjbhFVDgEgz3w8S"', '"PUB_K1_7yBtksm8Kkg85r4in4uCbfN77uRwe82apM8jjbhFVDgEcarGb8"');
    check_type(0, js2Types, 'public_key', '"SNAX7WnhaKwHpbSidYuh2DF1qAExTRUtPEdZCaZqt75cKcixuQUtdA"', '"PUB_K1_7WnhaKwHpbSidYuh2DF1qAExTRUtPEdZCaZqt75cKcixtU7gEn"');
    check_type(0, js2Types, 'public_key', '"SNAX7Bn1YDeZ18w2N9DU4KAJxZDt6hk3L7eUwFRAc1hb5bp6xJwxNV"', '"PUB_K1_7Bn1YDeZ18w2N9DU4KAJxZDt6hk3L7eUwFRAc1hb5bp6uEBZA8"');
    ...
    check_throw('Error: expected string containing public key', () => snaxjs_json_to_hex(js2Types, 'public_key', true));
    check_throw('Error: unrecognized public key format', () => snaxjs_json_to_hex(js2Types, 'public_key', 'foo'));
    ...
    check_throw('Error: expected string containing private key', () => snaxjs_json_to_hex(js2Types, 'private_key', true));
    check_throw('Error: unrecognized private key format', () => snaxjs_json_to_hex(js2Types, 'private_key', 'foo'));
    ...
    check_throw('Error: expected string containing signature', () => snaxjs_json_to_hex(js2Types, 'signature', true));
    check_throw('Error: unrecognized signature format', () => snaxjs_json_to_hex(js2Types, 'signature', 'foo'));
    check_type(0, js2Types, 'symbol_code', '"A"');
    check_type(0, js2Types, 'symbol_code', '"B"');
    check_type(0, js2Types, 'symbol_code', '"SNAX"');
    check_throw('Error: Expected string containing symbol_code', () => snaxjs_json_to_hex(js2Types, 'symbol_code', true));
    check_type(0, js2Types, 'symbol', '"0,A"');
    check_type(0, js2Types, 'symbol', '"1,Z"');
    check_type(0, js2Types, 'symbol', '"4,SNAX"');
    check_throw('Error: Expected string containing symbol', () => snaxjs_json_to_hex(js2Types, 'symbol', null));
    ...
    check_type(0, js2Types, 'asset', '"1.2345 SNAX"');
    check_type(0, js2Types, 'asset', '"-1.2345 SNAX"');
    check_throw('Error: Expected string containing asset', () => snaxjs_json_to_hex(js2Types, 'asset', null));
    ...
    check_type(token, tokenTypes, "transfer", '{"from":"useraaaaaaaa","to":"useraaaaaaab","quantity":"0.0001 SNAX","memo":"test memo"}');
...
async function push_transfer() {
    if (useTokenHexApi)
        check(l.abisnax_set_abi_hex(context, name('snax.token'), cstr(tokenHexApi)));
    else
        check(l.abisnax_set_abi(context, name('snax.token'), jsonStr((await rpc.get_abi('snax.token')).abi)));
    let type = checkPtr(l.abisnax_get_type_for_action(context, name('snax.token'), name('transfer')));
    check(l.abisnax_json_to_bin(context, name('snax.token'), type, jsonStr({
        from: 'useraaaaaaaa',
        to: 'useraaaaaaab',
        quantity: '0.0001 SNAX',
        memo: '',
    })));
    const actionDataHex = l.abisnax_get_bin_hex(context).readCString();
    console.log('action json->bin: ', actionDataHex);
    console.log('action bin->json: ', abisnax_hex_to_json(name('snax.token'), 'transfer', actionDataHex));
    ...
    check(l.abisnax_json_to_bin(context, 0, cstr('transaction'), jsonStr(transaction)));
    let transactionDataHex = l.abisnax_get_bin_hex(context).readCString();
    console.log('transaction json->bin: ', transactionDataHex);
    console.log('transaction bin->json: ', abisnax_hex_to_json(0, 'transaction', transactionDataHex));
...
(async () => {
    try {
        check(context);
        check(l.abisnax_set_abi(context, 0, jsonStr(transactionAbi)));
        check_types();
        if (useRpcEndpoint)
            await push_transfer();
    } catch (e) {
