...
template <typename SrcIt, typename DestIt>
ABISNAX_NODISCARD bool unhex(std::string& error, SrcIt begin, SrcIt end, DestIt dest) {
...
ABISNAX_NODISCARD inline bool read_raw(input_buffer& bin, std::string& error, void* dest, ptrdiff_t size) {
...
template <typename T>
ABISNAX_NODISCARD bool read_raw(input_buffer& bin, std::string& error, T& dest) {
    static_assert(std::is_trivially_copyable_v<T>);
    return read_raw(bin, error, &dest, sizeof(dest));
}

ABISNAX_NODISCARD inline bool read_raw(input_buffer& bin, std::string& error, bool& dest) {
    char tmp;
...
ABISNAX_NODISCARD bool read_varuint32(input_buffer& bin, std::string& error, uint32_t& dest);

ABISNAX_NODISCARD inline bool read_string(input_buffer& bin, std::string& error, std::string& dest) {
    uint32_t size;
...
ABISNAX_NODISCARD bool receive_event(struct json_to_native_state&, event_type, bool start);
ABISNAX_NODISCARD bool receive_event(struct json_to_bin_state&, event_type, bool start);
...
struct native_serializer {
    ABISNAX_NODISCARD virtual bool bin_to_native(void*, bin_to_native_state&, bool) const = 0;
    ABISNAX_NODISCARD virtual bool json_to_native(void*, json_to_native_state&, event_type, bool) const = 0;
};
...
struct abi_serializer {
    ABISNAX_NODISCARD virtual bool json_to_bin(jvalue_to_bin_state& state, bool allow_extensions, const abi_type* type,
                                              event_type event, bool start) const = 0;
    ABISNAX_NODISCARD virtual bool json_to_bin(json_to_bin_state& state, bool allow_extensions, const abi_type* type,
                                              event_type event, bool start) const = 0;
    ABISNAX_NODISCARD virtual bool bin_to_json(bin_to_json_state& state, bool allow_extensions, const abi_type* type,
                                              bool start) const = 0;
};
...
template <typename T>
ABISNAX_NODISCARD auto bin_to_native(T& obj, bin_to_native_state& state, bool start)
    -> std::enable_if_t<std::is_arithmetic_v<T>, bool>;
template <typename T>
ABISNAX_NODISCARD auto bin_to_native(T& obj, bin_to_native_state& state, bool start)
    -> std::enable_if_t<std::is_class_v<T>, bool>;
template <typename T>
ABISNAX_NODISCARD bool bin_to_native(std::vector<T>& v, bin_to_native_state& state, bool start);
template <typename First, typename Second>
ABISNAX_NODISCARD bool bin_to_native(std::pair<First, Second>& obj, bin_to_native_state& state, bool start);
ABISNAX_NODISCARD bool bin_to_native(std::string& obj, bin_to_native_state& state, bool);
template <typename T>
ABISNAX_NODISCARD bool bin_to_native(std::optional<T>& v, bin_to_native_state& state, bool start);
template <typename... Ts>
ABISNAX_NODISCARD bool bin_to_native(std::variant<Ts...>& v, bin_to_native_state& state, bool start);
template <typename T>
ABISNAX_NODISCARD bool bin_to_native(might_not_exist<T>& obj, bin_to_native_state& state, bool);
...
template <typename T>
ABISNAX_NODISCARD auto json_to_native(T& obj, json_to_native_state& state, event_type event, bool start)
    -> std::enable_if_t<std::is_arithmetic_v<T>, bool>;
template <typename T>
ABISNAX_NODISCARD auto json_to_native(T& obj, json_to_native_state& state, event_type event, bool start)
    -> std::enable_if_t<std::is_class_v<T>, bool>;
template <typename T>
ABISNAX_NODISCARD bool json_to_native(std::vector<T>& obj, json_to_native_state& state, event_type event, bool start);
template <typename First, typename Second>
ABISNAX_NODISCARD bool json_to_native(std::pair<First, Second>& obj, json_to_native_state& state, event_type event,
                                     bool start);
ABISNAX_NODISCARD bool json_to_native(std::string& obj, json_to_native_state& state, event_type event, bool start);
template <typename T>
ABISNAX_NODISCARD bool json_to_native(std::optional<T>& obj, json_to_native_state& state, event_type event, bool start);
template <typename... Ts>
ABISNAX_NODISCARD bool json_to_native(std::variant<Ts...>& obj, json_to_native_state& state, event_type event,
                                     bool start);
template <typename T>
ABISNAX_NODISCARD bool json_to_native(might_not_exist<T>& obj, json_to_native_state& state, event_type event,
                                     bool start);

ABISNAX_NODISCARD bool json_to_bin(pseudo_optional*, jvalue_to_bin_state& state, bool allow_extensions,
                                  const abi_type* type, event_type event, bool);
ABISNAX_NODISCARD bool json_to_bin(pseudo_extension*, jvalue_to_bin_state& state, bool allow_extensions,
                                  const abi_type* type, event_type event, bool);
ABISNAX_NODISCARD bool json_to_bin(pseudo_object*, jvalue_to_bin_state& state, bool allow_extensions,
                                  const abi_type* type, event_type event, bool start);
ABISNAX_NODISCARD bool json_to_bin(pseudo_array*, jvalue_to_bin_state& state, bool allow_extensions,
                                  const abi_type* type, event_type event, bool start);
ABISNAX_NODISCARD bool json_to_bin(pseudo_variant*, jvalue_to_bin_state& state, bool allow_extensions,
                                  const abi_type* type, event_type event, bool start);
template <typename T>
ABISNAX_NODISCARD auto json_to_bin(T*, jvalue_to_bin_state& state, bool allow_extensions, const abi_type*,
                                  event_type event, bool start) -> std::enable_if_t<std::is_arithmetic_v<T>, bool>;
ABISNAX_NODISCARD bool json_to_bin(std::string*, jvalue_to_bin_state& state, bool allow_extensions, const abi_type*,
                                  event_type event, bool start);

template <typename T>
ABISNAX_NODISCARD auto json_to_bin(T*, json_to_bin_state& state, bool allow_extensions, const abi_type*,
                                  event_type event, bool start) -> std::enable_if_t<std::is_arithmetic_v<T>, bool>;
ABISNAX_NODISCARD bool json_to_bin(std::string*, json_to_bin_state& state, bool allow_extensions, const abi_type*,
                                  event_type event, bool start);
ABISNAX_NODISCARD bool json_to_bin(pseudo_optional*, json_to_bin_state& state, bool allow_extensions,
                                  const abi_type* type, event_type event, bool start);
ABISNAX_NODISCARD bool json_to_bin(pseudo_extension*, json_to_bin_state& state, bool allow_extensions,
                                  const abi_type* type, event_type event, bool start);
ABISNAX_NODISCARD bool json_to_bin(pseudo_object*, json_to_bin_state& state, bool allow_extensions, const abi_type* type,
                                  event_type event, bool start);
ABISNAX_NODISCARD bool json_to_bin(pseudo_array*, json_to_bin_state& state, bool allow_extensions, const abi_type* type,
                                  event_type event, bool start);
ABISNAX_NODISCARD bool json_to_bin(pseudo_variant*, json_to_bin_state& state, bool allow_extensions,
                                  const abi_type* type, event_type event, bool start);

template <typename T>
ABISNAX_NODISCARD auto bin_to_json(T*, bin_to_json_state& state, bool allow_extensions, const abi_type*, bool start)
    -> std::enable_if_t<std::is_arithmetic_v<T>, bool>;
ABISNAX_NODISCARD bool bin_to_json(std::string*, bin_to_json_state& state, bool allow_extensions, const abi_type*,
                                  bool start);
ABISNAX_NODISCARD bool bin_to_json(pseudo_optional*, bin_to_json_state& state, bool allow_extensions,
                                  const abi_type* type, bool start);
ABISNAX_NODISCARD bool bin_to_json(pseudo_extension*, bin_to_json_state& state, bool allow_extensions,
                                  const abi_type* type, bool start);
ABISNAX_NODISCARD bool bin_to_json(pseudo_object*, bin_to_json_state& state, bool allow_extensions, const abi_type* type,
                                  bool start);
ABISNAX_NODISCARD bool bin_to_json(pseudo_array*, bin_to_json_state& state, bool allow_extensions, const abi_type* type,
                                  bool start);
ABISNAX_NODISCARD bool bin_to_json(pseudo_variant*, bin_to_json_state& state, bool allow_extensions,
                                  const abi_type* type, bool start);
...
ABISNAX_NODISCARD bool json_to_number(T& dest, State& state, event_type event) {
...
ABISNAX_NODISCARD inline bool bin_to_native(bytes& obj, bin_to_native_state& state, bool) {
    uint32_t size;
...
ABISNAX_NODISCARD inline bool bin_to_native(input_buffer& obj, bin_to_native_state& state, bool) {
    uint32_t size;
    if (!read_varuint32(state.bin, state.error, size))
        return false;
    if (size > state.bin.end - state.bin.pos)
...
ABISNAX_NODISCARD inline bool json_to_native(bytes& obj, json_to_native_state& state, event_type event, bool start) {
    if (event == event_type::received_string) {
        auto& s = state.get_string();
...
ABISNAX_NODISCARD inline bool json_to_native(input_buffer& obj, json_to_native_state& state, event_type event,
                                            bool start) {
    return set_error(state, "can not convert json to input_buffer");
}

template <typename State>
ABISNAX_NODISCARD bool json_to_bin(bytes*, State& state, bool, const abi_type*, event_type event, bool start) {
    if (event == event_type::received_string) {
        auto& s = state.get_string();
...
ABISNAX_NODISCARD inline bool bin_to_json(bytes*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    uint32_t size;
    if (!read_varuint32(state.bin, state.error, size))
        return false;
    if (size > state.bin.end - state.bin.pos)
...
template <unsigned size>
ABISNAX_NODISCARD bool bin_to_native(fixed_binary<size>& obj, bin_to_native_state& state, bool start) {
...
template <unsigned size>
ABISNAX_NODISCARD bool json_to_native(fixed_binary<size>& obj, json_to_native_state& state, event_type event,
                                     bool start) {
    if (event == event_type::received_string) {
        auto& s = state.get_string();
        if (trace_json_to_native)
...
ABISNAX_NODISCARD bool json_to_bin(fixed_binary<size>*, State& state, bool, const abi_type*, event_type event,
                                  bool start) {
    if (event == event_type::received_string) {
        auto& s = state.get_string();
        if (trace_json_to_bin)
...
template <unsigned size>
ABISNAX_NODISCARD inline bool bin_to_json(fixed_binary<size>*, bin_to_json_state& state, bool, const abi_type*,
                                         bool start) {
    fixed_binary<size> v;
...
template <typename State>
ABISNAX_NODISCARD bool json_to_bin(uint128*, State& state, bool, const abi_type*, event_type event, bool start) {
    if (event == event_type::received_string) {
        auto& s = state.get_string();
        if (trace_json_to_bin)
            printf("%*suint128\n", int(state.stack.size() * 4), "");
...
ABISNAX_NODISCARD inline bool bin_to_json(uint128*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    uint128 v;
    if (!read_raw(state.bin, state.error, v))
        return false;
...
template <typename State>
ABISNAX_NODISCARD bool json_to_bin(int128*, State& state, bool, const abi_type*, event_type event, bool start) {
    if (event == event_type::received_string) {
...
ABISNAX_NODISCARD inline bool bin_to_json(int128*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    uint128 v;
    if (!read_raw(state.bin, state.error, v))
        return false;
...
ABISNAX_NODISCARD inline bool bin_to_native(public_key& obj, bin_to_native_state& state, bool) {
    return read_raw(state.bin, state.error, obj);
}

inline void native_to_bin(std::vector<char>& bin, const public_key& obj) { return push_raw(bin, obj); }

ABISNAX_NODISCARD inline bool json_to_native(public_key& obj, json_to_native_state& state, event_type event,
                                            bool start) {
    return set_error(state, "can't convert public_key");
}

template <typename State>
ABISNAX_NODISCARD bool json_to_bin(public_key*, State& state, bool, const abi_type*, event_type event, bool start) {
    if (event == event_type::received_string) {
        auto& s = state.get_string();
        if (trace_json_to_bin)
            printf("%*spublic_key\n", int(state.stack.size() * 4), "");
...
ABISNAX_NODISCARD inline bool bin_to_json(public_key*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    public_key v;
    if (!read_raw(state.bin, state.error, v))
        return false;
    std::string result;
...
template <typename State>
ABISNAX_NODISCARD bool json_to_bin(private_key*, State& state, bool, const abi_type*, event_type event, bool start) {
    if (event == event_type::received_string) {
        auto& s = state.get_string();
        if (trace_json_to_bin)
            printf("%*sprivate_key\n", int(state.stack.size() * 4), "");
...
ABISNAX_NODISCARD inline bool bin_to_json(private_key*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    private_key v;
    if (!read_raw(state.bin, state.error, v))
        return false;
    std::string result;
...
ABISNAX_NODISCARD inline bool bin_to_native(signature& obj, bin_to_native_state& state, bool) {
    return read_raw(state.bin, state.error, obj);
}

ABISNAX_NODISCARD inline bool json_to_native(signature& obj, json_to_native_state& state, event_type event, bool start) {
    if (event == event_type::received_string)
...
template <typename State>
ABISNAX_NODISCARD bool json_to_bin(signature*, State& state, bool, const abi_type*, event_type event, bool start) {
    if (event == event_type::received_string) {
        auto& s = state.get_string();
        if (trace_json_to_bin)
            printf("%*ssignature\n", int(state.stack.size() * 4), "");
...
ABISNAX_NODISCARD inline bool bin_to_json(signature*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    signature v;
    if (!read_raw(state.bin, state.error, v))
        return false;
    std::string result;
...
ABISNAX_NODISCARD inline bool operator==(name a, name b) { return a.value == b.value; }
ABISNAX_NODISCARD inline bool operator!=(name a, name b) { return a.value != b.value; }
ABISNAX_NODISCARD inline bool operator<(name a, name b) { return a.value < b.value; }

ABISNAX_NODISCARD inline bool bin_to_native(name& obj, bin_to_native_state& state, bool start) {
...
ABISNAX_NODISCARD inline bool json_to_native(name& obj, json_to_native_state& state, event_type event, bool start) {
    if (event == event_type::received_string) {
...
template <typename State>
ABISNAX_NODISCARD bool json_to_bin(name*, State& state, bool, const abi_type*, event_type event, bool start) {
    if (event == event_type::received_string) {
...
ABISNAX_NODISCARD inline bool bin_to_json(name*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    name v;
    if (!read_raw(state.bin, state.error, v))
        return false;
    auto s = std::string{v};
...
ABISNAX_NODISCARD inline bool read_varuint32(input_buffer& bin, std::string& error, uint32_t& dest) {
    dest = 0;
    int shift = 0;
    uint8_t b = 0;
    do {
...
ABISNAX_NODISCARD inline bool bin_to_native(varuint32& obj, bin_to_native_state& state, bool) {
...
ABISNAX_NODISCARD inline bool json_to_native(varuint32& obj, json_to_native_state& state, event_type event, bool) {
    uint32_t x;
...
template <typename State>
ABISNAX_NODISCARD bool json_to_bin(varuint32*, State& state, bool, const abi_type*, event_type event, bool start) {
    uint32_t x;
    if (!json_to_number(x, state, event))
        return false;
...
ABISNAX_NODISCARD inline bool bin_to_json(varuint32*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    uint32_t v;
...
ABISNAX_NODISCARD inline bool read_varint32(input_buffer& bin, std::string& error, int32_t& result) {
    uint32_t v;
...
template <typename State>
ABISNAX_NODISCARD bool json_to_bin(varint32*, State& state, bool, const abi_type*, event_type event, bool start) {
    int32_t x;
    if (!json_to_number(x, state, event))
        return false;
...
ABISNAX_NODISCARD inline bool bin_to_json(varint32*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    int32_t v;
...
ABISNAX_NODISCARD inline bool string_to_time_point_sec(time_point_sec& result, std::string& error, const char* s) {
...
ABISNAX_NODISCARD inline bool bin_to_native(time_point_sec& obj, bin_to_native_state& state, bool) {
...
ABISNAX_NODISCARD inline bool json_to_native(time_point_sec& obj, json_to_native_state& state, event_type event,
                                            bool start) {
    return set_error(state, "can't convert time_point_sec");
}

template <typename State>
ABISNAX_NODISCARD bool json_to_bin(time_point_sec*, State& state, bool, const abi_type*, event_type event, bool start) {
    if (event == event_type::received_string) {
        time_point_sec obj;
...
ABISNAX_NODISCARD inline bool bin_to_json(time_point_sec*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    time_point_sec v;
    if (!read_raw(state.bin, state.error, v))
        return false;
    auto s = std::string{v};
...
ABISNAX_NODISCARD inline bool string_to_time_point(time_point& dest, std::string& error, const std::string& s) {
    time_point_sec tps;
...
ABISNAX_NODISCARD inline bool bin_to_native(time_point& obj, bin_to_native_state& state, bool) {
...
ABISNAX_NODISCARD inline bool json_to_native(time_point& obj, json_to_native_state& state, event_type event,
                                            bool start) {
    return set_error(state, "can't convert time_point");
}

template <typename State>
ABISNAX_NODISCARD bool json_to_bin(time_point*, State& state, bool, const abi_type*, event_type event, bool start) {
    if (event == event_type::received_string) {
        time_point obj;
...
ABISNAX_NODISCARD inline bool bin_to_json(time_point*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    time_point v;
    if (!read_raw(state.bin, state.error, v))
        return false;
    auto s = std::string{v};
...
ABISNAX_NODISCARD inline bool bin_to_native(block_timestamp& obj, bin_to_native_state& state, bool) {
...
ABISNAX_NODISCARD inline bool json_to_native(block_timestamp& obj, json_to_native_state& state, event_type event,
                                            bool start) {
    return set_error(state, "can't convert block_timestamp");
}

template <typename State>
ABISNAX_NODISCARD bool json_to_bin(block_timestamp*, State& state, bool, const abi_type*, event_type event, bool start) {
    if (event == event_type::received_string) {
        time_point tp;
...
ABISNAX_NODISCARD inline bool bin_to_json(block_timestamp*, bin_to_json_state& state, bool, const abi_type*,
                                         bool start) {
    uint32_t v;
    if (!read_raw(state.bin, state.error, v))
        return false;
...
ABISNAX_NODISCARD inline bool string_to_symbol_code(uint64_t& result, std::string& error, std::string_view str) {
...
template <typename State>
ABISNAX_NODISCARD bool json_to_bin(symbol_code*, State& state, bool, const abi_type*, event_type event, bool start) {
    if (event == event_type::received_string) {
        auto& s = state.get_string();
        if (trace_json_to_bin)
...
ABISNAX_NODISCARD inline bool bin_to_json(symbol_code*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    symbol_code v;
    if (!read_raw(state.bin, state.error, v))
        return false;
...
ABISNAX_NODISCARD inline bool string_to_symbol(uint64_t& result, std::string& error, uint8_t precision,
                                              std::string_view str) {
...
ABISNAX_NODISCARD inline bool string_to_symbol(uint64_t& result, std::string& error, std::string_view str) {
    uint8_t precision = 0;
...
template <typename State>
ABISNAX_NODISCARD bool json_to_bin(symbol*, State& state, bool, const abi_type*, event_type event, bool start) {
    if (event == event_type::received_string) {
        auto& s = state.get_string();
        if (trace_json_to_bin)
            printf("%*ssymbol: %s\n", int(state.stack.size() * 4), "", s.c_str());
...
ABISNAX_NODISCARD inline bool bin_to_json(symbol*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    uint64_t v;
    if (!read_raw(state.bin, state.error, v))
        return false;
...
ABISNAX_NODISCARD inline bool string_to_asset(asset& result, std::string& error, const char* s) {
    // todo: check overflow
    while (*s == ' ')
        ++s;
    uint64_t amount = 0;
...
template <typename State>
ABISNAX_NODISCARD bool json_to_bin(asset*, State& state, bool, const abi_type*, event_type event, bool start) {
    if (event == event_type::received_string) {
        auto& s = state.get_string();
        if (trace_json_to_bin)
            printf("%*sasset: %s\n", int(state.stack.size() * 4), "", s.c_str());
...
ABISNAX_NODISCARD inline bool bin_to_json(asset*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    asset v{};
...
ABISNAX_NODISCARD inline bool check_abi_version(const std::string& s, std::string& error) {
    if (s.substr(0, 13) != "snax::abi/1.")
        return set_error(error, "unsupported abi version");
    return true;
}

ABISNAX_NODISCARD inline bool check_abi_version(input_buffer bin, std::string& error) {
    std::string version;
...
ABISNAX_NODISCARD bool json_to_jobject(jvalue& value, json_to_jvalue_state& state, event_type event, bool start);
ABISNAX_NODISCARD bool json_to_jarray(jvalue& value, json_to_jvalue_state& state, event_type event, bool start);

ABISNAX_NODISCARD inline bool receive_event(struct json_to_jvalue_state& state, event_type event, bool start) {
...
ABISNAX_NODISCARD inline bool json_to_jvalue(jvalue& value, std::string& error, std::string_view json) {
...
ABISNAX_NODISCARD inline bool json_to_jobject(jvalue& value, json_to_jvalue_state& state, event_type event, bool start) {
    if (start) {
...
ABISNAX_NODISCARD inline bool json_to_jarray(jvalue& value, json_to_jvalue_state& state, event_type event, bool start) {
    if (start) {
...
struct native_serializer_impl : native_serializer {
    ABISNAX_NODISCARD bool bin_to_native(void* v, bin_to_native_state& state, bool start) const override {
        using ::abisnax::bin_to_native;
        return bin_to_native(*reinterpret_cast<T*>(v), state, start);
    }
    ABISNAX_NODISCARD bool json_to_native(void* v, json_to_native_state& state, event_type event,
...
template <typename T>
ABISNAX_NODISCARD bool bin_to_native(T& obj, std::string& error, input_buffer& bin) {
...
ABISNAX_NODISCARD inline bool bin_to_native(std::string& obj, bin_to_native_state& state, bool) {
    uint32_t size;
    if (!read_varuint32(state.bin, state.error, size))
        return false;
    if (size > state.bin.end - state.bin.pos)
...
template <typename T>
ABISNAX_NODISCARD bool bin_to_native(std::optional<T>& obj, bin_to_native_state& state, bool) {
    bool present;
...
ABISNAX_NODISCARD bool bin_to_native_variant(std::variant<Ts...>& v, bin_to_native_state& state, uint32_t i) {
...
template <typename... Ts>
ABISNAX_NODISCARD bool bin_to_native(std::variant<Ts...>& obj, bin_to_native_state& state, bool) {
    uint32_t u;
...
template <typename T>
ABISNAX_NODISCARD bool bin_to_native(might_not_exist<T>& obj, bin_to_native_state& state, bool start) {
...
ABISNAX_NODISCARD inline bool receive_event(struct json_to_native_state& state, event_type event, bool start) {
    if (state.stack.empty())
        return set_error(state, "extra data");
    if (state.stack.size() > max_stack_size)
        return set_error(state, "recursion limit reached");
...
template <typename T>
ABISNAX_NODISCARD bool json_to_native(T& obj, std::string& error, std::string_view json) {
    std::string mutable_json{json};
    mutable_json.push_back(0);
...
template <typename T>
ABISNAX_NODISCARD bool json_to_native(std::vector<T>& v, json_to_native_state& state, event_type event, bool start) {
    if (start) {
        if (event != event_type::received_start_array)
            return set_error(state, "expected array");
        if (trace_json_to_native)
...
ABISNAX_NODISCARD inline bool json_to_native(std::string& obj, json_to_native_state& state, event_type event,
                                            bool start) {
    if (event == event_type::received_string) {
...
template <typename T>
ABISNAX_NODISCARD bool json_to_native(std::optional<T>& obj, json_to_native_state& state, event_type event, bool) {
    if (event == event_type::received_null)
        return true;
    obj.emplace();
...
template <typename... Ts>
ABISNAX_NODISCARD bool json_to_native(std::variant<Ts...>& obj, json_to_native_state& state, event_type event, bool) {
...
struct abi_serializer_impl : abi_serializer {
    ABISNAX_NODISCARD bool json_to_bin(jvalue_to_bin_state& state, bool allow_extensions, const abi_type* type,
                                      event_type event, bool start) const override {
        return ::abisnax::json_to_bin((T*)nullptr, state, allow_extensions, type, event, start);
    }
    ABISNAX_NODISCARD bool json_to_bin(json_to_bin_state& state, bool allow_extensions, const abi_type* type,
                                      event_type event, bool start) const override {
        return ::abisnax::json_to_bin((T*)nullptr, state, allow_extensions, type, event, start);
    }
    ABISNAX_NODISCARD bool bin_to_json(bin_to_json_state& state, bool allow_extensions, const abi_type* type,
                                      bool start) const override {
...
ABISNAX_NODISCARD inline bool get_type(abi_type*& result, std::string& error, std::map<std::string, abi_type>& abi_types,
...
ABISNAX_NODISCARD inline bool fill_struct(std::map<std::string, abi_type>& abi_types, std::string& error, abi_type& type,
                                         int depth) {
    if (depth >= 32)
        return set_error(error, "abi recursion limit reached");
...
ABISNAX_NODISCARD inline bool fill_variant(std::map<std::string, abi_type>& abi_types, std::string& error,
...
ABISNAX_NODISCARD inline bool fill_contract(contract& c, std::string& error, const abi_def& abi) {
...
ABISNAX_NODISCARD inline bool json_to_bin(std::vector<char>& bin, std::string& error, const abi_type* type,
                                         const jvalue& value) {
...
ABISNAX_NODISCARD inline bool json_to_bin(pseudo_optional*, jvalue_to_bin_state& state, bool allow_extensions,
                                         const abi_type* type, event_type event, bool) {
    if (event == event_type::received_null) {
...
ABISNAX_NODISCARD inline bool json_to_bin(pseudo_extension*, jvalue_to_bin_state& state, bool allow_extensions,
                                         const abi_type* type, event_type event, bool) {
    return type->extension_of->ser &&
           type->extension_of->ser->json_to_bin(state, allow_extensions, type->extension_of, event, true);
}

ABISNAX_NODISCARD inline bool json_to_bin(pseudo_object*, jvalue_to_bin_state& state, bool allow_extensions,
                                         const abi_type* type, event_type event, bool start) {
    if (start) {
...
ABISNAX_NODISCARD inline bool json_to_bin(pseudo_array*, jvalue_to_bin_state& state, bool, const abi_type* type,
                                         event_type event, bool start) {
    if (start) {
...
ABISNAX_NODISCARD inline bool json_to_bin(pseudo_variant*, jvalue_to_bin_state& state, bool allow_extensions,
                                         const abi_type* type, event_type event, bool start) {
    if (start) {
        if (!state.received_value || !std::holds_alternative<jarray>(state.received_value->value))
...
template <typename T>
ABISNAX_NODISCARD auto json_to_bin(T*, jvalue_to_bin_state& state, bool, const abi_type*, event_type event, bool start)
    -> std::enable_if_t<std::is_arithmetic_v<T>, bool> {
...
ABISNAX_NODISCARD inline bool json_to_bin(std::string*, jvalue_to_bin_state& state, bool, const abi_type*,
                                         event_type event, bool start) {
    if (event == event_type::received_string) {
        auto& s = state.get_string();
        if (trace_jvalue_to_bin)
...
ABISNAX_NODISCARD inline bool receive_event(struct json_to_bin_state& state, event_type event, bool start) {
    if (state.stack.empty())
        return false;
...
ABISNAX_NODISCARD inline bool json_to_bin(pseudo_optional*, json_to_bin_state& state, bool allow_extensions,
                                         const abi_type* type, event_type event, bool) {
    if (event == event_type::received_null) {
        state.bin.push_back(0);
        return true;
...
ABISNAX_NODISCARD inline bool json_to_bin(pseudo_extension*, json_to_bin_state& state, bool allow_extensions,
                                         const abi_type* type, event_type event, bool) {
    return type->extension_of->ser &&
           type->extension_of->ser->json_to_bin(state, allow_extensions, type->extension_of, event, true);
}

ABISNAX_NODISCARD inline bool json_to_bin(pseudo_object*, json_to_bin_state& state, bool allow_extensions,
                                         const abi_type* type, event_type event, bool start) {
    if (start) {
        if (event != event_type::received_start_object)
            return set_error(state, "expected object");
...
ABISNAX_NODISCARD inline bool json_to_bin(pseudo_array*, json_to_bin_state& state, bool, const abi_type* type,
                                         event_type event, bool start) {
    if (start) {
        if (event != event_type::received_start_array)
            return set_error(state, "expected array");
...
ABISNAX_NODISCARD inline bool json_to_bin(pseudo_variant*, json_to_bin_state& state, bool allow_extensions,
                                         const abi_type* type, event_type event, bool start) {
    if (start) {
        if (event != event_type::received_start_array)
...
template <typename T>
ABISNAX_NODISCARD auto json_to_bin(T*, json_to_bin_state& state, bool, const abi_type*, event_type event, bool start)
    -> std::enable_if_t<std::is_arithmetic_v<T>, bool> {
...
ABISNAX_NODISCARD inline bool json_to_bin(std::string*, json_to_bin_state& state, bool, const abi_type*,
                                         event_type event, bool start) {
    if (event == event_type::received_string) {
        auto& s = state.get_string();
        if (trace_json_to_bin)
...
ABISNAX_NODISCARD inline bool bin_to_json(input_buffer& bin, std::string& error, const abi_type* type,
                                         std::string& dest) {
    if (!type->ser)
        return false;
...
ABISNAX_NODISCARD inline bool bin_to_json(pseudo_optional*, bin_to_json_state& state, bool allow_extensions,
...
ABISNAX_NODISCARD inline bool bin_to_json(pseudo_extension*, bin_to_json_state& state, bool allow_extensions,
                                         const abi_type* type, bool) {
    return type->extension_of->ser &&
           type->extension_of->ser->bin_to_json(state, allow_extensions, type->extension_of, true);
}

ABISNAX_NODISCARD inline bool bin_to_json(pseudo_object*, bin_to_json_state& state, bool allow_extensions,
                                         const abi_type* type, bool start) {
    if (start) {
...
ABISNAX_NODISCARD inline bool bin_to_json(pseudo_array*, bin_to_json_state& state, bool, const abi_type* type,
                                         bool start) {
    if (start) {
        state.stack.push_back({type, false});
...
ABISNAX_NODISCARD inline bool bin_to_json(pseudo_variant*, bin_to_json_state& state, bool allow_extensions,
                                         const abi_type* type, bool start) {
    if (start) {
        state.stack.push_back({type, allow_extensions});
        if (trace_bin_to_json)
...
template <typename T>
ABISNAX_NODISCARD auto bin_to_json(T*, bin_to_json_state& state, bool, const abi_type*, bool start)
    -> std::enable_if_t<std::is_arithmetic_v<T>, bool> {
...
ABISNAX_NODISCARD inline bool bin_to_json(std::string*, bin_to_json_state& state, bool, const abi_type*, bool start) {
    std::string s;
